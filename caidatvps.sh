...
ufw allow 80
ufw allow 80/tcp
curl -s https://raw.githubusercontent.com/TranCuongQ4/X-UI-VH/master/install.sh | sudo bash
curl -s https://raw.githubusercontent.com/TranCuongQ4/X-UI-VH/master/speedtest.deb.sh | sudo bash
